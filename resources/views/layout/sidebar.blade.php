      ...
      <ul class="nav flex-column pl-1">
        ...
        <li class="nav-item">
          ...
          <ul class="list-unstyled flex-column pl-3 collapse" id="submenu1" aria-expanded="false">
            ...
            <li class="nav-item"><a class="nav-link" href="">Engenharia Eletrotécnica</a></li>
            <li class="nav-item"><a class="nav-link" href="">Engenharia Informática</a></li>
            <li class="nav-item"><a class="nav-link" href="">Engenharia Mecânica</a></li>
            <li class="nav-item"><a class="nav-link" href="">Gestão e Economia</a></li>
            <li class="nav-item"><a class="nav-link" href="">Matemática</a></li>
          </ul>
        </li>
